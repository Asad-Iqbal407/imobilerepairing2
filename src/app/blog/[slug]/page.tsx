...
const fallbackPosts: Record<string, any> = {
  'common-iphone-battery-issues': {
    ...
    content: `
      ...
      <p>At IMOBILE, we can replace your iPhone battery in under 30 minutes with premium quality parts.</p>
    `,
    author: 'IMOBILE Team',
  ...
  'water-damage-recovery-guide': {
    ...
    content: `
      ...
      <p>Bring it to a professional repair shop like IMOBILE immediately for ultrasonic cleaning and drying.</p>
    `,
    author: 'Tech Expert',
